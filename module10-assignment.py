...
# Your code here
missing_value_report = initial_missing_counts
...
temp_df = raw_df.copy()
temp_df['satisfaction_rating'] = temp_df['satisfaction_rating'].fillna(satisfaction_median)
...
# - Low: < 5 purchases
# Your code here
df_no_duplicates.loc[:, 'purchase_frequency_category'] = 'Low'
df_no_duplicates.loc[df_no_duplicates['total_purchases'] >= 5, 'purchase_frequency_category'] = 'Medium'
df_no_duplicates.loc[df_no_duplicates['total_purchases'] >= 10, 'purchase_frequency_category'] = 'High'
...
# Your code here
df_final = df_renamed.drop(columns=['Email', 'Phone Number'])
...
print("- Missing Values:", initial_missing_counts.sum(), "total missing entries")
print("-", initial_duplicate_count, "duplicate records found")
print("- Data Type Issues: date columns had mixed formats, total_spent contained currency symbols/commas, and numeric fields needed conversion")
...
print("- Top Category:", category_revenue.idxmax(), "with $", round(category_revenue.max(), 2), "revenue")

# 9.4 Display the first few rows of the clean, analysis-ready dataset
# REQUIRED: Display first 5 rows of 'df_final'
# Your code here
print("\nFirst 5 rows of analysis-ready dataset:")
print(df_final.head())
